...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 08, 2022 lúc 09:43 PM
...
CREATE TABLE `color` (
  ...
  `colordescription` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(23, '2022_04_08_144001_cart', 1),
(24, '2022_04_08_144001_category', 1),
(25, '2022_04_08_144001_color', 1),
(26, '2022_04_08_144001_order', 1),
(27, '2022_04_08_144001_product', 1),
(28, '2022_04_08_144001_role', 1),
(29, '2022_04_08_144001_size', 1),
(30, '2022_04_08_144001_users', 1);
...
CREATE TABLE `size` (
  ...
  `size` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sizedescription` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `size`
  MODIFY `sizeid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
