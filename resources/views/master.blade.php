@include('header')
    @yield('homepage')
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <video id="bannervideo" loop="" autoplay="" playsinline="" src="https://brand.assets.adidas.com/image/upload/q_auto,vc_auto/enUS/Images/ss22-originals-superstar-always-on-combo-hp-mh-large-d_tcm221-843316.mp4"></video>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <div class="button">
                                                <div class="background">
                                                    <button><h5>SHOP MEN   <i class="fa-solid fa-right-long"></i></h5></button>
                                                </div>
                                                <div class="background">
                                                    <button><h5>SHOP WOMEN   <i class="fa-solid fa-right-long"></i></h5></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-8">
       ...
       <section>
            <div class="recommend">
                <h2 style="text-align: center; font-family: 'URW Geometric'; padding: 50px;">- BEST SELLER -</h2>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-2"></div>
                        <div class="col-xl-8">
                            ...
                            <div class="container-fluid" style="padding: 0;">
                                <div class="row">
                                    <div class="col-xl-3">
                                        ...
                                        <a href="#">
                                            <div class="card" style="width: 100%; ">
                                                <img src="{{'BevisSneaker'}}/images/product/adidas-stan/002.jpg" class="card-img-top" >
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-xl-3">
                                        ...
                                        <a href="#">
                                            <div class="card" style="width: 100%; ">
                                                <img src="{{'BevisSneaker'}}/images/product/adidas-stan/005.jpg" class="card-img-top" >
                                            </div>
                                        </a>
                                        <a href="#">
                                            <div class="card" style="width: 100%; ">
                                                <img src="{{'BevisSneaker'}}/images/product/adidas-stan/009.jpg" class="card-img-top" >
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-xl-3">
                                        ...
                                        <a href="#">
                                            <div class="card" style="width: 100%; ">
                                                <img src="{{'BevisSneaker'}}/images/product/adidas-stan/008.jpg" class="card-img-top" >
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-xl-3">
                                        ...
                                        <a href="#">
                                            <div class="card" style="width: 100%; ">
                                                <img src="{{'BevisSneaker'}}/images/product/adidas-stan/006.jpg" class="card-img-top" >
                                            </div>
                                        </a>
                                    </div>
                                </div>
