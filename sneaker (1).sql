...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 10, 2022 lúc 01:23 PM
...
('admin', 'Quách Công Tuấn', '$2y$10$w2gki9dZpWewHjHnGnXlau6ee4u28ikMBziEDdXQK3rx8eEmLDlPG', 'admin@fpt.edu.vn', '0981979901', '22 P. Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội, Việt Nam', 'Hà Nội', 1),
('ducmy', 'Pham Duc My', '$2y$10$RIFjMlJJvRmYI8wvhDzXfOAKyEWEFy0DTWBAsN3zIVa1mxGrd3cVi', 'ducmy@gmail.com', '09819799011', 'Au Co', 'Hà Nội', 1);
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`detail`) REFERENCES `detail` (`id`);

--
-- Các ràng buộc cho bảng `detail`
--
ALTER TABLE `detail`
  ADD CONSTRAINT `detail_ibfk_1` FOREIGN KEY (`product`) REFERENCES `product` (`productid`),
  ADD CONSTRAINT `detail_ibfk_2` FOREIGN KEY (`size`) REFERENCES `size` (`sizeid`);
